...
bool png_to_icns(const fs::path &png_path, const fs::path &icns_path) {
    @autoreleasepool {
        NSString *pngPathStr = [NSString stringWithUTF8String:png_path.string().c_str()];
...
bool create_launcher(const fs::path exe_path, const fs::path macOS_path, const std::string &app_path) {
    @autoreleasepool {
        ...
        NSString *exePathStr = [NSString stringWithUTF8String:exe_path.string().c_str()];
        NSString *macOSPath = [NSString stringWithUTF8String:macOS_path.string().c_str()];
...
bool create_info_plist(const fs::path contents_path, const std::string &app_name, const std::string &app_path) {
    @autoreleasepool {
        NSString *contentsPath = [NSString stringWithUTF8String:contents_path.string().c_str()];
